...
# ///
# this_file: src/lmstrix/data/jinja2_templates/translategemma_test.py
"""End-to-end test tool for the TranslateGemma LM Studio chat template."""
...
MODEL_ID = "translategemma-4b-it-8bit"
LMSTUDIO_URL = "http://localhost:1234/api/v1/chat"
LOCAL_TEMPLATE_DIR = Path(__file__).parent
LIVE_TEMPLATE_PATH = Path(
    "/Volumes/Falstaff4T/RomeoData2/lmstudio/models/mlx-community/translategemma-4b-it-8bit/chat_template.jinja"
)
...
def deploy(template_file: str = "translategemma.jinja2") -> Path:
...
def run(template_file: str = "translategemma.jinja2", timeout: float = 120.0) -> None:
