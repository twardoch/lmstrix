...
def test_scan_and_update_adds_new_models(mock_lmstudio_client, mock_models_file):
    """
...
def test_scan_and_update_removes_deleted_models(mock_lmstudio_client, mock_models_file):
    """
...
def test_scan_and_update_preserves_test_data(mock_lmstudio_client, mock_models_file):
    """
...
def test_load_from_non_existent_file(mock_models_file):
    """
...
def test_save_and_load_cycle(mock_models_file):
    """
