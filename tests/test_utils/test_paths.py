...
class TestPathUtilities:
    ...
    def test_get_lmstudio_path_shared_location(self, tmp_path):
        ...
        shared_path = Path("/Users/Shared/lmstudio")
        
        with patch("pathlib.Path.home", return_value=home_dir):
            with patch("pathlib.Path.exists") as mock_exists:
                def exists_side_effect(self):
                    if str(self) == str(home_dir / ".lmstudio-home-pointer"):
                        return False
                    elif str(self) == str(home_dir / ".cache" / "lm-studio"):
                        return False
                    elif str(self) == "/Users/Shared/lmstudio":
                        return True
                    elif str(self) == "/Users/Shared/lmstudio/models":
                        return True
                    return False
