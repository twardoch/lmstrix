...
def test_get_lmstudio_path_from_pointer(mock_home) -> None:
    """
    ...
    # This syntax error needs to be investigated - seems like a mock setup issue
...
@patch("lmstrix.utils.paths.Path.home")
def test_fallback_to_default_directories(mock_home, mock_exists) -> None:
    """
...
@patch("lmstrix.utils.paths.Path.exists")
@patch("lmstrix.utils.paths.Path.home")
def test_no_path_found_raises_error(mock_home, mock_exists) -> None:
    """
...
def test_get_default_models_file_path(mock_get_lmstudio_path) -> None:
    """
